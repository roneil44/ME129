...
if __name__ == "__main__":
    ...
    io.set_PWM_dutycycle(MTR1_LEGA, 100)
    io.set_PWM_dutycycle(MTR1_LEGB,   0)
    io.set_PWM_dutycycle(MTR2_LEGA, 100)
    io.set_PWM_dutycycle(MTR2_LEGB,   0)
    time.sleep(1)

    print("Driving Forward at Medium Speed...")
    ...
    print("Turn 180...")
    io.set_PWM_dutycycle(MTR1_LEGA, 155)
    io.set_PWM_dutycycle(MTR1_LEGB, 0)
    io.set_PWM_dutycycle(MTR2_LEGA, 0)
    io.set_PWM_dutycycle(MTR2_LEGB, 155)
    time.sleep(1)
